...
This is an app that attempts to find duplicate image by their visual content, rather than file content similarity. It is written in WPF C# and compiles in Visual Studio Community 2022. Done with the help of AI as I am not a coder. For now, it's ugly, it has terrible performance, but it does the job.
